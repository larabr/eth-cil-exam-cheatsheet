...
\textbf{Choice of base} depends on signal. Fourier for global, wavelet for local support. PCA basis optimal for given $\Sigma$. Stripes \& check patterns: hi-freq in Fourier.
